...
public class UserService {
    ...
    public void validateRegistration(User user, String password, String passwordConfirmation) throws ValidationException {
        ...
        if (user.getEmail().length() > 250) {
            throw new ValidationException("E-mail can't be longer than 250 letters");
        }
        ...
        if (!password.equals(passwordConfirmation)) {
            throw new ValidationException("Password's and  are not equals");
        }
    }
    ...
    public int validateEnter(String loginOrEmail, String password) throws ValidationException {
